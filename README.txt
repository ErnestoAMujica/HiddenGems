...
run python3 server.py in server/venv
server is now running at http://localhost:8080/api/home


Note: you only need to do this once (aside from npm run dev and python3 server.py) and this just prevents you from having to push the constantly changing node files everytime you make any change to the project
